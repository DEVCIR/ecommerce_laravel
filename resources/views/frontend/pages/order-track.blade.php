...
@section('main-content')
    ...
    <!-- End Breadcrumbs -->
<section class="py-5 tracking_box_area section_gap">
    <div class="container">
        <div class="tracking_box_inner">
            ...
            <form class="my-4 row tracking_form" action="{{route('product.track.order')}}" method="post" novalidate="novalidate">
              @csrf
                <div class="col-md-8 form-group">
                    <input type="text" class="p-2 form-control"  name="order_number" placeholder="Enter your order number">
                </div>
                <div class="col-md-8 form-group">
