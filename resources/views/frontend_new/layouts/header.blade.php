                    ...
                    <div class="col-lg-6"> 
                        <div class="header-contact">
                            <ul>
                                ...
                                @endphp
                                <li><i class="fa fa-phone" aria-hidden="true"></i>@foreach($settings as $data) {{$data->phone}} @endforeach</li>
                                <li><i class="fa fa-envelope" aria-hidden="true"></i>@foreach($settings as $data) {{$data->email}} @endforeach</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                ...
                                <div class="brand-logo">
                                    <a href="index.html"><img src="https://themes.pixelstrap.com/multikart/assets/images/icon/logo.png"
                                    ...
                                    <div class="icon-nav d-none d-sm-block">
                                        <ul>
                                            <li class="onhover-div mobile-search">
                                                <div><img src="https://themes.pixelstrap.com/multikart/assets/images/icon/search.png" onclick="openSearch()"
                                                        class="img-fluid blur-up lazyload" alt=""> <i class="ti-search"
                                                        onclick="openSearch()"></i></div>
                                            </li>
                                            <li class="onhover-div mobile-setting">
                                                <div><img src="https://themes.pixelstrap.com/multikart/assets/images/icon/setting.png"
                                                        class="img-fluid blur-up lazyload" alt=""> <i
                                                        class="ti-settings"></i></div>
                                            </li>
                                            <li class="onhover-div mobile-cart">
                                                <div><img src="https://themes.pixelstrap.com/multikart/assets/images/icon/cart.png"
                                                        class="img-fluid blur-up lazyload" alt=""> <i
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-xl-4">
                                                                <a href="#" class="mega-menu-banner"><img
                                                                        src="https://themes.pixelstrap.com/multikart/assets/images/mega-menu/fashion.jpg"
                                            ...
                                            <ul class="mega-menu full-mega-menu">
                                                <li>
                                                    <div class="container">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <img src="https://themes.pixelstrap.com/multikart/assets/images/menu-banner.jpg"
                                        ...
                                        <li class="onhover-div mobile-cart">
                                            ...
                                            <ul class="show-div shopping-cart">
                                                <li>
                                                    <div class="media">
                                                        <a href="#"><img alt="" class="me-3"
                                                                src="https://themes.pixelstrap.com/multikart/assets/images/fashion/product/1.jpg"></a>
                                                ...
                                                <li>
                                                    <div class="media">
                                                        <a href="#"><img alt="" class="me-3"
                                                                src="https://themes.pixelstrap.com/multikart/assets/images/fashion/product/2.jpg"></a>
                                                        <div class="media-body">
                                                            <a href="#">
                                                                <h4>item name</h4>
                                                            </a>
