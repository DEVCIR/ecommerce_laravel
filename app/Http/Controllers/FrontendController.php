...
class FrontendController extends Controller
{
    ...
    public function home(){
        ...
        $bannerstwo=HomeSlider::where('status','active')->limit(2)->orderBy('id','DESC')->get();
        // return $banner;
    ...
    public function subscribe(Request $request)
{
    ...
    // You can also set other fields like 'category', 'status', and 'time_stamp' if needed
    $subscriber->save();

    // Perform any other actions or send confirmation emails if necessary
